...
abstract contract BaseMigrate is BaseDeploy {
        ...
        returns (address contractAddress)
    {
        ...
        console.log(unicode"Logic 🧩: ".green(), string.concat(_explorerUrl(), vm.toString(contractAddress)));
    }
        ...
        returns (address proxy)
    {
        ...
        console.log(unicode"Logic 🧩: ".green(), string.concat(_explorerUrl(), vm.toString(logic)));
        console.log(unicode"Proxy ⚙️ : ".green(), string.concat(_explorerUrl(), vm.toString(proxy)));
    }
        ...
        returns (address proxy)
    {
        address logic = deploy(fileDest, EMPTY_ARGS);
        proxy =
            deploy("TransparentUpgradeableProxy.sol:TransparentUpgradeableProxy", abi.encode(logic, msg.sender, args));
        console.log(unicode"Logic 🧩: ".green(), string.concat(_explorerUrl(), vm.toString(logic)));
        console.log(unicode"Proxy ⚙️ : ".green(), string.concat(_explorerUrl(), vm.toString(proxy)));
    }
    ...
    function upgradeProxy(string memory fileDest, address proxy, bytes memory args)
        public
        log(string.concat(unicode"Upgrading 🛠️ ", fileDest))
    {
        address logic = deploy(fileDest, EMPTY_ARGS);
